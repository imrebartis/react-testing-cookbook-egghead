...
describe('quoteReducer', () => {
  ...
  it('should return previous state when trying to remove quote with a non-existent id', () => {
    const action = removeQuoteById({
      id: 521
    });
    const actual = quoteReducer(stateBefore(), action);
  ...
  it('should return previous state when trying to change the like count on a quote with a non-existent id', () => {
    const action = unlikeQuoteById({
      id: 241
    });
    const actual = quoteReducer(stateBefore(), action);
